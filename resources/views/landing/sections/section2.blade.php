...
<div class="">
    ...
    <!--end::Curve top-->
    <!--begin::Wrapper-->
    <div class="pb-15 pt-18" style="background-color: #f776a1">
        <!--begin::Container-->
        <div class="container">
            <!--begin::Heading-->
            <div class="text-center mt-15 mb-7" id="benefit" data-kt-scroll-offset="{default: 100, lg: 150}">
                <!--begin::Title-->
                <h3 class="fs-3hx text-white fw-bolder mb-5">Pencarian Game Lebih Mudah</h3>
                <!--end::Title-->
                <!--begin::Description-->
                <div class="fs-5 text-gray-800 fw-bold">Kami menyiapkan banyak daftar game yang cocok </br>untuk kamu
                    para calon juara.
                </div>
                <!--end::Description-->
            </div>
            ...
            <div class="d-flex flex-center">
                <!--begin::Items-->
                <div class="d-flex flex-wrap flex-center justify-content-lg-between mb-7 mx-auto w-xl-900px">
                    <!--begin::Item-->
                    <div class=""></div>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <div class=" d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                        ...
                        <div class="mb-0">
                            ...
                            <div class="fs-lg-2hx fs-2x fw-bolder text-white d-flex flex-center">
                                <div class="min-w-70px text-center" data-kt-countup="true" data-kt-countup-value="{{ $avgCount }}"
                                    data-kt-countup-suffix="+">0</div>
                            </div>
                            <!--end::Value-->
                            <!--begin::Label-->
                            <span class="text-white fw-bold fs-5 lh-0">Total Game</span>
                            <!--end::Label-->
                        </div>
                        <!--end::Info-->
                    </div>
