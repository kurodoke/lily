            ...
            <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-dark-bg"
                ...
                <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
                    ...
                    <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                        ...
                        <!--end::Title-->
                        <!--begin::Action-->
                        <a href="../../demo3/dist/index.html" class="btn btn-primary">Try Metronic</a>
                        <!--end::Action-->
                    </div>
                    <!--end::Heading-->
                    <!--begin::Clients-->
                ...
                <div class="row w-100 gy-10 mb-md-20">
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <img src="assets/media/illustrations/dozzy-1/2.png" class="mh-125px mb-9"
                                alt="" />
                            <!--end::Illustration-->
                            <!--begin::Heading-->
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <img src="assets/media/illustrations/dozzy-1/8.png" class="mh-125px mb-9"
                                alt="" />
                            <!--end::Illustration-->
                            <!--begin::Heading-->
                            <div class="d-flex flex-center mb-5">
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <img src="assets/media/illustrations/dozzy-1/12.png" class="mh-125px mb-9"
                                alt="" />
                            <!--end::Illustration-->
                            <!--begin::Heading-->
                            <div class="d-flex flex-center mb-5">
            ...
            <div class="pb-15 pt-18 landing-dark-bg">
                ...
                <div class="container">
                    ...
                    <div class="fs-2 fw-bold text-muted text-center">
                        <a href="../../demo3/dist/account/security.html" class="link-primary fs-4 fw-bolder">Marcus
                            Levy,</a>
                        ...
                        <div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
                            ...
                            <div class="rounded landing-dark-border p-9">
                                ...
                                <span class="fw-normal fs-4 text-gray-700">Use Our Custom Development Service.
                                    <a href="../../demo3/dist/pages/profile/overview.html"
