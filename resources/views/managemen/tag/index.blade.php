...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            @include('managemen.tag.flash.error')
            @include('managemen.tag.flash.success')
    ...
    @include('managemen.tag.modal.add')
    @include('managemen.tag.modal.edit')
    @include('managemen.tag.modal.delete')


@endsection


@include('managemen.tag.script')
