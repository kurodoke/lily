               ...
               <div class="modal-content rounded">
                   ...
                   <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                       ...
                       <form id="kt_modal_add_form" class="form"
                           action="{{ route('admin.managemen.tag.store') }}" method="POST">
                           @csrf
                           <!--begin::Heading-->
                           <div class="mb-13 text-center">
                               <!--begin::Title-->
                               <h1 class="mb-3">Tambah Tag</h1>
                               <!--end::Title-->
                               <!--begin::Description-->
                               <div class="text-muted fw-bold fs-5 mb-3">Tambahkan Tag - Tag untuk Game anak - anak
                               </div>
                               <!--end::Description-->
                           </div>
                           <!--end::Heading-->
                           <div class="row">
                               ...
                               <div class="col-md-12 d-flex flex-column mb-8 fv-row">
                                   ...
                                   <input type="text" class="form-control form-control-solid"
                                       placeholder="Masukkan Nama Tag" name="tag_name" />
                               </div>
                               <!--end::Input group-->
                           </div>
