...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            @include('managemen.pembelajaran.flash.error')
            @include('managemen.pembelajaran.flash.success')
    ...
    @include('managemen.pembelajaran.modal.add')
    @include('managemen.pembelajaran.modal.edit')
    @include('managemen.pembelajaran.modal.delete')


@endsection


@include('managemen.pembelajaran.script')
