                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                            ...
                            <div class="rating">
                                ...
                                <!--begin::Star 1-->
                                <label class="rating-label me-3" for="kt_rating_edit_input_1">
                                ...
                                <!--begin::Star 2-->
                                <label class="rating-label me-3" for="kt_rating_edit_input_2">
                                    <i class="bi bi-star-fill fs-5"></i>
                                </label>
                                ...
                                <!--begin::Star 3-->
                                <label class="rating-label me-3" for="kt_rating_edit_input_3">
                                    <i class="bi bi-star-fill fs-5"></i>
                                </label>
                                ...
                                <!--begin::Star 4-->
                                <label class="rating-label me-3" for="kt_rating_edit_input_4">
                                    <i class="bi bi-star-fill fs-5"></i>
                                </label>
                                ...
                                <!--begin::Star 5-->
                                <label class="rating-label me-3" for="kt_rating_edit_input_5">
                                    <i class="bi bi-star-fill fs-5"></i>
                                </label>
