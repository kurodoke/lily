           ...
           <div class="modal-dialog modal-dialog-centered mw-650px">
               ...
               <div class="modal-content rounded">
                   ...
                   <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                       <!--begin:Form-->
                       <form id="kt_modal_detail_form" class="form" action="#" method="POST"
                           ...
                           <div class="row">
                               ...
                               <div class="col-md-12 d-flex flex-column mb-8 fv-row">
                                   ...
                                   <textarea class="form-control form-control-solid" rows="3" name="game_description"
                                       placeholder="Masukkan Deskripsi Game" @readonly(true)></textarea>
                               </div>
                               <!--end::Input group-->
                               ...
                               <div class="col-md-6 d-flex flex-column mb-8 fv-row justify-content-center">
                                   ...
                                   <div class="rating">
                                       ...
                                       <!--begin::Star 1-->
                                       <label class="rating-label pe-3" for="kt_rating_detail_input_1">
                                           <i class="bi bi-star-fill fs-3"></i>
                                       </label>
                                       <input class="rating-input" name="game_rating" value="1" type="radio"
                                           id="kt_rating_detail_input_1" disabled />
                                       <!--end::Star 1-->

                                       <!--begin::Star 2-->
                                       <label class="rating-label pe-3" for="kt_rating_detail_input_2">
                                           <i class="bi bi-star-fill fs-3"></i>
                                       </label>
                                       <input class="rating-input" name="game_rating" value="2" type="radio"
                                           id="kt_rating_detail_input_2" disabled />
                                       <!--end::Star 2-->

                                       <!--begin::Star 3-->
                                       <label class="rating-label pe-3" for="kt_rating_detail_input_3">
                                           <i class="bi bi-star-fill fs-3"></i>
                                       </label>
                                       <input class="rating-input" name="game_rating" value="3" type="radio"
                                           id="kt_rating_detail_input_3" disabled />
                                       <!--end::Star 3-->

                                       <!--begin::Star 4-->
                                       <label class="rating-label pe-3" for="kt_rating_detail_input_4">
                                           <i class="bi bi-star-fill fs-3"></i>
                                       </label>
                                       <input class="rating-input" name="game_rating" value="4" type="radio"
                                           id="kt_rating_detail_input_4" disabled />
                                       <!--end::Star 4-->

                                       <!--begin::Star 5-->
                                       <label class="rating-label pe-3" for="kt_rating_detail_input_5">
                                           <i class="bi bi-star-fill fs-3"></i>
                                       </label>
                                       <input class="rating-input" name="game_rating" value="5" type="radio"
                                           id="kt_rating_detail_input_5" disabled />
                                       <!--end::Star 5-->
                                   </div>
                               </div>
                               <!--end::Input group-->
                               ...
                               <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                   ...
                                   <select class="form-select" data-control="select2" name="game_premium"
                                       ...
                                       id="kt_select_detail_premium" required @disabled(true)>
                               ...
                               <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                   ...
                                   <input type="text" class="form-control form-control-solid overflow-hidden "
                                       ...
                                       id="kt_tagify_detail_design" @readonly(true) />
                               </div>
                               <!--end::Input group-->
                               <!--begin::Input group-->
                               <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                   ...
                                   <input type="text" class="form-control form-control-solid overflow-hidden "
                                       ...
                                       id="kt_tagify_detail_creativity" @readonly(true) />
                               </div>
                               <!--end::Input group-->
                               <!--begin::Input group-->
                               <div class="col-md-6 d-flex flex-column mb-8 fv-row">
                                   ...
                                   <input type="text" class="form-control form-control-solid overflow-hidden "
                                       ...
                                       id="kt_tagify_detail_learn" @readonly(true) />
                               </div>
                               <!--end::Input group-->
                           </div>
