...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            @include('admin.game.flash.success')
            @include('admin.game.flash.error')
    ...
    @include('admin.game.modal.add')
    @include('admin.game.modal.edit')
    @include('admin.game.modal.detail')
    @include('admin.game.modal.delete')
