...
@section('subtitle', 'Admin ➞ Pengelolaan data ➞ Design Game')
...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            @include('admin.managemen.design.flash.error')
            @include('admin.managemen.design.flash.success')
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-4 fw-bolder" data-kt-countup="true"
                                            data-kt-countup-value="{{ $design->count() }}">0
                                        </div>
                                    </div>
                                    <!--end::Number-->
                                    <!--begin::Label-->
                            ...
                            <tbody class="fs-6">
                                @foreach ($design as $_design)
                                    <tr>
                                        ...
                                        <td>{{ $_design->design_name }}</td>
                                        <td class="">
                                            <a href="#" class="btn btn-info btn-sm edit-button"
                                                data-id="{{ $_design->id }}" data-bs-toggle="modal"
                                                data-bs-target="#kt_modal_edit" onclick="edit(this)">Edit</a>
                                            <a href="#" class="btn btn-danger btn-sm delete-button"  data-id="{{ $_design->id }}"
    ...
    @include('admin.managemen.design.modal.add')
    @include('admin.managemen.design.modal.edit')
    @include('admin.managemen.design.modal.delete')


@endsection


@include('admin.managemen.design.script')
