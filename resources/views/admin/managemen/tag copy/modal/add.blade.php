               ...
               <div class="modal-content rounded">
                   ...
                   <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                       ...
                       <form id="kt_modal_add_form" class="form"
                           action="{{ route('admin.managemen.kategori.store') }}" method="POST">
                           @csrf
                           <!--begin::Heading-->
                           <div class="mb-13 text-center">
                               ...
                               <!--end::Title-->
                               <!--begin::Description-->
                               <div class="text-muted fw-bold fs-5 mb-3">Tambahkan Kategori - Kategori untuk Game anak - anak
                               </div>
                               <!--end::Description-->
                           </div>
                           <!--end::Heading-->
                           <div class="row">
                               ...
                               <div class="col-md-12 d-flex flex-column mb-8 fv-row">
                                   ...
                                   <input type="text" class="form-control form-control-solid"
                                       placeholder="Masukkan Nama Kategori" name="category_name" />
                               </div>
                               <!--end::Input group-->
                           </div>
