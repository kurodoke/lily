...
@section('subtitle', 'Admin ➞ Pengelolaan data ➞ Kreatifitas Game')
...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            @include('admin.managemen.kreatifitas.flash.error')
            @include('admin.managemen.kreatifitas.flash.success')
    ...
    @include('admin.managemen.kreatifitas.modal.add')
    @include('admin.managemen.kreatifitas.modal.edit')
    @include('admin.managemen.kreatifitas.modal.delete')


@endsection


@include('admin.managemen.kreatifitas.script')
