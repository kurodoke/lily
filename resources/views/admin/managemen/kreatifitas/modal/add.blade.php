               ...
               <div class="modal-content rounded">
                   ...
                   <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                       ...
                       <form id="kt_modal_add_form" class="form"
                           action="{{ route('admin.managemen.kreatifitas.store') }}" method="POST">
                           @csrf
                           <!--begin::Heading-->
                           <div class="mb-13 text-center">
                               <!--begin::Title-->
                               <h1 class="mb-3">Tambah Kreatifitas</h1>
                               <!--end::Title-->
                               <!--begin::Description-->
                               <div class="text-muted fw-bold fs-5 mb-3">Tambahkan Kreatifitas - Kreatifitas untuk Game anak - anak
                               </div>
                               <!--end::Description-->
                           </div>
                           <!--end::Heading-->
                           <div class="row">
                               ...
                               <div class="col-md-12 d-flex flex-column mb-8 fv-row">
                                   ...
                                   <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                       <span class="required">Nama Kreatifitas</span>

                                   </label>
                                   <!--end::Label-->
                                   <input type="text" class="form-control form-control-solid"
                                       placeholder="Masukkan Nama Kreatifitas" name="creativity_name" />
                               </div>
                               <!--end::Input group-->
                           </div>
