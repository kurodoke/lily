...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            @include('admin.managemen.pembelajaran.flash.error')
            @include('admin.managemen.pembelajaran.flash.success')
            ...
            <div class="card card-flush mt-6 mt-xl-9">
                ...
                <div class="card-header mt-5">
                    ...
                    <div class="card-title flex-column">
                        <h3 class="fw-bolder mb-1">Tabel Pembelajaran</h3>
                        <!--begin::Description-->
                        <div class="d-flex flex-wrap fw-bold mb-4 fs-5 text-gray-400">Pengelolaan data pembelajaran - pembelajaran yang ada pada game</div>
                        <!--end::Description-->
                    </div>
                    <div class="">
                        ...
                        <div class="d-flex mb-4">
                            <a href="#" class="btn btn-sm btn-warning me-3" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_add">Tambah Pembelajaran</a>
                            <!--begin::Menu-->
                        </div>
                        <!--end::Actions-->
                        <!--begin::Info-->
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-4 fw-bolder" data-kt-countup="true"
                                            data-kt-countup-value="{{ $learns->count() }}">0
                                        </div>
                                    </div>
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-bold fs-6 text-gray-400">Total Pembelajaran</div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Stat-->
                            </div>
                        ...
                        <table id="kt_datatable"
                            ...
                            <thead class="fs-7 text-gray-400 text-uppercase">
                                <tr>
                                    ...
                                    <th class="min-w-150px">Pembelajaran</th>
                            ...
                            <tbody class="fs-6">
                                @foreach ($learns as $learn)
                                    <tr>
                                        ...
                                        <td>{{ $learn->learn_name }}</td>
                                        <td class="">
                                            <a href="#" class="btn btn-info btn-sm edit-button"
                                                data-id="{{ $learn->id }}" data-bs-toggle="modal"
                                                data-bs-target="#kt_modal_edit" onclick="edit(this)">Edit</a>
                                            <a href="#" class="btn btn-danger btn-sm delete-button"  data-id="{{ $learn->id }}"
    ...
    @include('admin.managemen.pembelajaran.modal.add')
    @include('admin.managemen.pembelajaran.modal.edit')
    @include('admin.managemen.pembelajaran.modal.delete')


@endsection


@include('admin.managemen.pembelajaran.script')
