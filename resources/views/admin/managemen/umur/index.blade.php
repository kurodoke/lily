...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            @include('admin.managemen.umur.flash.error')
            @include('admin.managemen.umur.flash.success')
    ...
    @include('admin.managemen.umur.modal.add')
    @include('admin.managemen.umur.modal.edit')
    @include('admin.managemen.umur.modal.delete')


@endsection


@include('admin.managemen.umur.script')
